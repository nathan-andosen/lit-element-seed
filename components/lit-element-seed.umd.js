(function (global, factory) {
  ...
  function (_HTMLElement) {
    _inheritsLoose(UpdatingElement, _HTMLElement);
    ...
    _proto._propertyToAttribute = function _propertyToAttribute(name, value) {
    ...
    _proto._requestUpdate = function _requestUpdate(name, oldValue) {
  ...
  */
  ...
  function (_UpdatingElement) {
    _inheritsLoose(LitElement, _UpdatingElement);
    ...
    _proto.connectedCallback = function connectedCallback() {
      _UpdatingElement.prototype.connectedCallback.call(this); // Note, first update/render handles styleElement so we only call this if
  ...
  var headerTemplate = html(_templateObject$1());
  var mainTemplate = function mainTemplate(data) {
    return html(_templateObject2$1(), headerTemplate, data.message);
  };
  ...
  function (_LitElement) {
    ...
    function StatusAlertComponent() {
      ...
      _this = _LitElement.call(this) || this; // Uncomment this if you do not want to create a shadow dom
      // createRenderRoot() {
      //   return this;
      // }
